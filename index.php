...
$work = [
   [
    ...
    "start_work" => "январь 2015",
    "end" => "февраль 2018",
    "text" => "Помощь в подготовке и согласовании договоров, разработка документации",
   ],
   [
    "title" => "Юрист",
    "start_work" => "Март 2018",
    "end" => "Январь 2021",
    "text" => "Участие в судебных процессах, разработка юридическо документации, взаимодействие с государственными и муниципальными органами",
   ],
   [
    "title" => "Начальник юридического отдела",
    "start_work" => "Февраль 2021",
    "end" => "По настоящее время",
    "text" => "Полное юридическое сопровождение деятельности компании",
   ],
];
?>
<!DOCTYPE html>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $work[$i]['title']; ?></b></h5>
          <h6 class="w3-text-teal">
            <i class="fa fa-calendar fa-fw w3-margin-right"></i>
            <?php echo $work[$i]['start_work']; ?> - 
            <?php if ($i==2): ?>
